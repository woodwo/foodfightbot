...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            "fighter_id", sa.Integer, sa.ForeignKey("fighters.id"), primary_key=True
        ),
        sa.Column(
    ...
    op.execute(
        "INSERT INTO user_fighters_new (user_id, fighter_id) SELECT user_id, fighter_id FROM user_fighters"
    )
